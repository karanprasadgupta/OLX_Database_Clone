...
CREATE TABLE `message` (
  ...
  CONSTRAINT `rec_phone` FOREIGN KEY (`reciever_id`) REFERENCES `user` (`phone`),
  CONSTRAINT `send_phone` FOREIGN KEY (`sender_id`) REFERENCES `user` (`phone`)
...
-- Dump completed on 2022-03-01 20:32:24
