...
CREATE TABLE `purchase` (
  ...
  CONSTRAINT `buyer` FOREIGN KEY (`buyer_id`) REFERENCES `user` (`phone`),
  CONSTRAINT `productid` FOREIGN KEY (`product_id`) REFERENCES `product` (`idproduct`),
  CONSTRAINT `seller` FOREIGN KEY (`seller_id`) REFERENCES `user` (`phone`)
...
-- Dump completed on 2022-02-28  3:13:13
